...
<!-- Page title -->
@section('pageTitle') View Roles @endsection
                        ...
                        <div class="col-sm-12">
                            <table id="datatable-fixed-header" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable-fixed-header_info"><thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_desc" tabindex="0" aria-controls="datatable-fixed-header" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 100px;" aria-sort="descending">Description</th>
                                ...
                                @foreach($roles as $role)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a href="{{route('editrole',['id'=>$role->id])}}" class="btn btn-facebook" >Edit</a>
                                            <a href="{{route('deleterole',['id'=>$role->id])}}" class="btn btn-danger" >Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
